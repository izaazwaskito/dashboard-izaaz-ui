                ...
                >
                  <div className='flex gap-1 w-full'>
                    <Button
                      variant='ghost'
                      size='sm'
                      className='w-2/3 text-[11px] h-8 justify-start gap-1 px-1.5'
                      onClick={toggleTheme}
                    >
                  ...
                  <Button
                    variant='ghost'
                    size='sm'
                    className='w-full text-[11px] h-8 justify-start gap-1.5 px-1.5'
                    onClick={() =>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <ArrowUpRight
                        size={14}
                        className={`opacity-0 group-hover:opacity-40 transition-all transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 ${
                          isActive
                            ? 'opacity-40 text-blue-500'
                            : 'text-zinc-400'
                        }`}
                      />
                    </Link>
