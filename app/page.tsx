      ...
      <div className="container mx-auto px-4 max-w-5xl border-x border-zinc-200 dark:border-zinc-800 border-dashed min-h-[calc(100vh-140px)] pb-20 relative z-10 flex-grow">
        ...
        >
          ...
          <motion.div className="space-y-6 text-left max-w-3xl" variants={itemVariants}>
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight leading-none flex flex-wrap items-center gap-x-3 gap-y-2">
                ...
                <span className="inline-flex items-center"><VerifyBadge /></span>
              </h1>
              <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed font-normal">
                An engineer focused on bridging the gap between <strong>QA Automation infrastructure</strong> and modern <strong>Frontend Development</strong>. Specialized in structuring resilient test automation environments for scale-critical banking platforms.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left" variants={itemVariants}>
            ...
            <Card className={`md:col-span-2 rounded-2xl border transition-all duration-300 relative overflow-hidden group ${
              isDark ? "bg-gradient-to-br from-zinc-900/40 via-zinc-900/20 to-transparent border-zinc-800 hover:border-zinc-700" : "bg-white border-zinc-200 hover:border-zinc-300"
            } shadow-sm`}>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  Architecting resilient end-to-end regression suites for high-availability core banking modules. Expert in constructing complex logical loopings, precise UI element bindings, and robust CI/CD integration models.
                </p>
                <div className="flex flex-wrap gap-2 pt-1 text-[11px] font-medium text-zinc-500">
                  <span className="px-2 py-0.5 rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">Playwright Framework</span>
                  <span className="px-2 py-0.5 rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">UiPath Enterprise</span>
                  <span className="px-2 py-0.5 rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">Katalon Studio</span>
                </div>
              </CardContent>
            </Card>
              ...
              <div>
                ...
                <CardContent>
                  <p className="text-xs md:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    Validating strict integration contract thresholds, testing real-time ingestion logic, and crafting backend automated pipeline assertions.
                  </p>
                </CardContent>
              </div>
            ...
            <Card className={`md:col-span-3 rounded-2xl border transition-all duration-300 relative overflow-hidden ${
              isDark ? "bg-zinc-900/40 border-zinc-800 hover:border-zinc-700" : "bg-white border-zinc-200 hover:border-zinc-300"
            } shadow-sm group`}>
              <div className="p-6 sm:p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                <div className="space-y-2 max-w-2xl">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-base font-bold">Frontend Engineering Ecosystem</h3>
                  </div>
                  <p className="text-xs md:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    Developing clean, accessible, and high-performance layout shells using <strong>React.js</strong> and <strong>Next.js</strong>. My dual engineering background ensures that applications are not only built seamlessly but are also structurally designed for effortless testability.
                  </p>
                </div>

                {/* Micro CTA Button to Project / About */}
                <Link href="/portofolio/about" className="inline-flex items-center gap-1.5 text-xs font-semibold px-4 py-2.5 rounded-xl border bg-zinc-950 text-zinc-50 hover:bg-zinc-900 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-zinc-200 transition-colors shrink-0 shadow-sm">
                  View Full Profile
