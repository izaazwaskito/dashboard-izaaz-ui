        ...
        >
          ...
          >
            <Button
              ...
              variant='outline'
              className={`text-xs font-semibold rounded-xl px-4 py-2 border transition-all backdrop-blur-sm ${
          ...
          >
            {currentItems.map((item, index) => (
              <Card
                key={index}
                className={`rounded-2xl border transition-all duration-300 p-5 flex flex-col justify-between backdrop-blur-sm ${
                  isDark
