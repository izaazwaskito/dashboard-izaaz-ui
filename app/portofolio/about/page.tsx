  ...
  return (
    ...
    <div className={`${isDark ? "bg-zinc-950 text-zinc-50" : "bg-zinc-50 text-zinc-900"} w-full font-inter min-h-screen transition-colors duration-300 relative flex flex-col`}>
      ...
      <div className="container mx-auto px-4 max-w-5xl border-x border-zinc-200 dark:border-zinc-800 border-dashed min-h-[calc(100vh-140px)] pb-20 relative z-10 flex-grow">
        <motion.div className="pt-12 space-y-14" initial="hidden" animate="visible" variants={fadeInUp}>
          ...
          <section className="space-y-4">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 p-6 rounded-2xl border ${isDark ? "bg-zinc-900/50 border-zinc-800" : "bg-white border-zinc-200"} shadow-sm`}>
              <div className="flex flex-col items-center text-center md:items-start md:text-left space-y-4 border-b md:border-b-0 md:border-r border-zinc-200 dark:border-zinc-800 pb-6 md:pb-0 md:pr-6">
                <Avatar className="w-24 h-24 border-2 border-primary/20">
                  ...
                  <AvatarFallback className="text-xl font-bold">IW</AvatarFallback>
                </Avatar>
                <div>
                  <h2 className="text-xl font-bold tracking-tight">Izaaz Waskito Widyarto</h2>
                  <p className="text-sm text-zinc-500 dark:text-zinc-400 font-medium mt-1">
                    QA Automation Engineer
                  </p>
                </div>
                <Button className="w-full md:w-auto text-xs bg-zinc-900 text-white dark:bg-white dark:text-zinc-900 hover:opacity-90" size="sm" asChild>
  {/* FIX: Menghapus atribut download, menambahkan target="_blank" agar PDF terbuka langsung di halaman tab baru */}
  <a href="/CV Izaaz Waskito.pdf" target="_blank" rel="noopener noreferrer">
    <Download size={14} className="mr-1.5" /> View & Download CV
              ...
              <div className="md:col-span-2 space-y-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300 align-middle my-auto">
                <p>
                  Hi, I'm <strong>Izaaz</strong>, a Computer Engineering graduate from Brawijaya University. I am a specialized <strong>QA Automation Engineer</strong> with rich experience handling core banking automation infrastructure, alongside a robust technical side-stack in <strong>Frontend</strong> and <strong>Node.js CLI Development</strong>.
                </p>
                <p>
                  My day-to-day work centers around structuring mission-critical automation systems for leading banking platforms—handling intricate transactions, regression suites, and custom reporting extensions that enhance developer pipelines.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className={`p-6 rounded-2xl border ${isDark ? "bg-zinc-900/50 border-zinc-800" : "bg-white border-zinc-200"}`}>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                  <div>
                    <h3 className="text-base font-bold">QA Automation Engineer</h3>
                    <p className="text-sm text-zinc-500">Bank BNI <span className="text-xs text-zinc-400 dark:text-zinc-500">(via NTT DATA Indonesia)</span></p>
                  </div>
                  <div className="text-left sm:text-right">
                    ...
                    <p className="text-xs text-zinc-400 mt-1.5">{bniDuration}</p>
                  </div>
                </div>
                <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-4 border-t border-zinc-100 dark:border-zinc-800/60 pt-4">
                  Developing robust testing ecosystems for high-availability banking pipelines. Crafting specialized automation mechanisms utilizing web terminal frameworks, handling precise loop-logics, and validating core transaction safety layers.
                </p>
              </div>

              {/* MANDIRI JOB */}
              <div className={`p-6 rounded-2xl border ${isDark ? "bg-zinc-900/30 border-zinc-800/60" : "bg-white border-zinc-200"} opacity-95`}>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                  <div>
                    <h3 className="text-base font-bold text-zinc-700 dark:text-zinc-300">QA Automation Engineer</h3>
                    <p className="text-sm text-zinc-500">Bank Mandiri <span className="text-xs text-zinc-400 dark:text-zinc-500">(via Adidata)</span></p>
                  </div>
                  <div className="text-left sm:text-right">
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-4 border-t border-zinc-100 dark:border-zinc-800/40 pt-4">
                  Spearheaded core end-to-end regression scripts for web and desktop platforms under the **Kopra Project**. Designed UiPath and Playwright automation architectures, structured secure DB patching tests, and improved deployment efficiency with early-stage CI/CD integrations.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className={`p-6 rounded-2xl border ${isDark ? "bg-gradient-to-br from-zinc-900/80 to-zinc-950 border-zinc-800" : "bg-gradient-to-br from-white to-zinc-50 border-zinc-200"} shadow-md relative overflow-hidden group`}>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    ...
                    <h3 className="text-lg font-bold mt-1.5 flex items-center gap-2">
                      Automated QA Reporting CLI Kit <span className="text-xs font-normal text-zinc-400">(Node.js & esbuild)</span>
                    </h3>
                  </div>
...
>
  ...
  <a href="/downloads/sample-qa-report.pdf" target="_blank" rel="noopener noreferrer">
    <Download size={14} className="mr-1.5" /> View Sample Report
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-300 max-w-3xl leading-relaxed">
                  A custom CLI and API-driven reporting tool developed from scratch using Node.js and esbuild. It automates the transformation of raw API/UI testing logs into stakeholder-ready PDF documents, cutting out 100% of manual post-testing paperwork.
                </p>

                <div className="flex flex-wrap gap-2 pt-2">
                  <span className={`text-[11px] px-2.5 py-1 rounded-md border font-medium ${
                    isDark ? "bg-zinc-800/50 border-zinc-800 text-zinc-300" : "bg-zinc-100 border-zinc-200 text-zinc-600"
                  }`}>
                    Node.js (CLI Built)
                  </span>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {skillCategories.map((category, idx) => (
                <div key={idx} className={`p-5 rounded-2xl border ${isDark ? "bg-zinc-900/30 border-zinc-800" : "bg-white border-zinc-200"} flex flex-col justify-between`}>
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {category.items.map((skill, index) => (
                        <div key={index} className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl border text-xs font-medium ${isDark ? "bg-zinc-900 border-zinc-800 text-zinc-300" : "bg-zinc-50 border-zinc-200 text-zinc-600"}`}>
