  ...
  const projectList = [
    {
      ...
      description: "Developing automated testing ecosystems for corporate banking transaction modules, including core transfers and clearing workflows. Structured robust locator strategies and conditional looping mechanisms inside virtualized web-terminal and web environments.",
      tech: ["UiPath Orchestrator", "Katalon Studio", "Advanced XPath", "API Regressions"],
    ...
    },
    {
      ...
      timeline: "2026",
      description: "Built an independent command-line interface utility to aggregate raw testing execution logs from API and UI suites, automatically generating polished, stakeholder-ready PDF summaries. Greatly reduced post-testing manual documentation overhead.",
    ...
    },
    {
      ...
      timeline: "2024 - 2025",
      description: "Architected end-to-end UI regression test scripts for wholesale digital banking features. Integrated test suites with secure staging databases during patch windows and built preliminary CI/CD delivery integrations to ensure build stability.",
        ...
        >
          ...
          <motion.div className="space-y-2 text-left" variants={itemVariants}>
            ...
            <p className="text-xs md:text-sm text-zinc-500 max-w-xl">
              A curated selection of core banking automation suites and developer utilities I have architected.
            </p>
          </motion.div>
